function localReset() {
    ...
    player.ponds.frog.multiplier.lvl = new Decimal('1');
    ...
    player.ponds.frog.tier3.cost = new Decimal('1e4');
    player.ponds.frog.tier4.cost = new Decimal('1e6');
    player.ponds.frog.tier5.cost = new Decimal('1e10');
